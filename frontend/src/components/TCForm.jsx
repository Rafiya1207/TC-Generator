...
const TCForm = () => {
	return (
		<form>
			<h1 className="form-heading">Fill Transfer Certificate Form</h1>
			<TextField
			...
			<FormLabel component="legend">Are You Promoted?</FormLabel>
			<RadioGroup
				row
				name="promoted"
			>
			...
			<FormLabel component="legend">Have you paid fee?</FormLabel>
			<RadioGroup
				row
				name="feePaid"
			>
			...
			<FormLabel component="legend">Applied for Sumoto?</FormLabel>
			<RadioGroup
				row
				name="appliedSumoto"
			>
